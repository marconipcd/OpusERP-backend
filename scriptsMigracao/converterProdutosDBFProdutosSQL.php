...
ini_set('max_execution_time','2000000');
		...
		{		
			...
			'$row2->CIDADE', '$row2->UF', '$row2->CEP', '$row2->FONE1', '$row2->FONE2', '$row2->FAX', '$row2->DPTVENDAS',
			'$row2->EMAIL', '$row2->HOME_PAGE', '$row2->REPRESENTANTE', '$row2->NOME_REPRESENTANTE',
			'$row2->CONTATO_REPRESENTANTE', '$row2->CIDADE_REPRESENTATNE', '$row2->UF_REPRESENTANTE',
			'$row2->FONE1_REPRESENTANTE', '$row2->FONE2_REPRESENTANTE', '$row2->FAX_REPRESENTANTE', '$row2->CEL_REPRESENTANTE',
			'2012-04-16')";
