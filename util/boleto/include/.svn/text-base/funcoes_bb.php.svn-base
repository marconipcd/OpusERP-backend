...
if ($dadosboleto["formatacao_convenio"] == "7") {
	...
	$nossonumero = $NovoNumero;
	$dv=modulo_11("$codigobanco$nummoeda$fator_vencimento$valor$livre_zeros$nossonumero$carteira");
	$linha="$codigobanco$nummoeda$dv$fator_vencimento$valor$livre_zeros$nossonumero$carteira";
