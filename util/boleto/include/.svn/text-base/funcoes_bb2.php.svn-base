...
$query_ultimoBoleto = "SELECT * FROM contasapagar ORDER BY id DESC";
$ultimoBoleto = mysql_query($query_ultimoBoleto, $system) or die(mysql_error());
$row_ultimoBoleto = mysql_fetch_assoc($ultimoBoleto);
$totalRows_ultimoBoleto = mysql_num_rows($ultimoBoleto);

$i = $row_ultimoBoleto['id'];
$codigobanco = "001";
//$codigo_banco_com_dv = geraCodigoBanco($codigobanco);
$nummoeda = "9";
$fator_vencimento = date("d/m/Y");
...
mysql_free_result($ultimoBoleto);
?>
