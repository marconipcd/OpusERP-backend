...
#instr_header {
	background:url(../../../imagens/logofundo.jpg);
	padding-left: 160px;
	height: 65px;
}
...
<div id="container">
	...
	<div id="instr_header">
		<h1>&nbsp;</h1>
</div>	<!-- id="instr_header" --><!-- id="instructions" -->
	
  <div id="boleto">
    <table cellspacing=0 cellpadding=0 width=666 border=0>
      <TBODY><TR><TD class=ct width=666><div align=right><b class=cp>Recibo
do Sacado</b></div></TD></tr></tbody></table>
		...
		<tr class="campos">
			<td class="sacado2">
				<p><?php echo ('<span style="text-transform:uppercase;">'.$dadosboleto["sacado"].'</span>');?></p>
				<p><?php echo ('<span style="text-transform:uppercase;">'.$dadosboleto["endereco1"].'</span>');?></p>
				<p><?php echo ('<span style="text-transform:uppercase;">'.$dadosboleto["endereco2"].'</span>');?></p>
			</td>
		</tr>
		</tbody>
		</table>		
